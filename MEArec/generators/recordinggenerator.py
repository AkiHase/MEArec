...
class RecordingGenerator:
    ...
    def generate_recordings(self, tmp_mode=None, tmp_folder=None, n_jobs=0):
        """
        ...
        assert isinstance(self._verbose, bool), "'verbose' must be bool"
        ...
        if only_noise:
            ...
            if tempgen is not None:
                ...
                t_pad = time.time()
                templates_pad = pad_templates(templates, pad_samples, drifting, dtype, self._verbose,
                ...
                if up != down:
                    ...
                    templates_rs = resample_templates(templates_pad, n_resample, up, down, drifting, dtype,
                                                      self._verbose, tmp_file=tmp_templates_rs,
                ...
                templates = jitter_templates(templates_rs, upsample, fs, n_jitters, jitter, drifting, dtype,
                                             self._verbose, tmp_file=tmp_templates_jit, parallel=parallel_templates)
                if self._verbose:
        ...
        if noise_level == 0:
            ...
            if noise_mode == 'uncorrelated':
                ...
                t_pad = time.time()
                templates_noise_pad = pad_templates(templates_noise, pad_samples, drifting, dtype, self._verbose,
